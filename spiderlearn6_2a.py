...
if __name__ == '__main__':
    ...
    for page in range(1,11):
        ...
        for result in results:
            ...
            #     f.write(str(result) + '\n')
            cur.execute('insert into weibom( id,text,attitudes,comments,reposts) value(%s,%s,%s,%s,%s)',(result['id'],result['text'],result['attitudes'],result['comments'],result['reposts']))
            db.commit()
    db.close()
